...
import { c as waHref, d as db, i as SOCIAL, n as DREAM_TEAM_URL, o as useContent } from "./router-DnsFphIK.mjs";
import { n as require_jsx_runtime, r as require_react } from "../_libs/react+tanstack__react-query.mjs";
import { S as useRouter, b as Link, p as useRouterState } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { n as useLenis } from "../_libs/lenis.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-header-DyIaj2XA.js
...
var EMAIL_SUBJECT = "Admission enquiry - Chaitanya EM High School";
var EMAIL_BODY = [
...
function ContactActions({ tel, whatsapp, email, className = "" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: actions.map(({ key, label, sub, href, ring, aria, Icon }, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.a, {
			href,
			"aria-label": aria,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "truncate text-[14px] font-bold tracking-tight text-slate-800 transition-colors group-hover:text-[var(--focus-ring)]",
					children: label
...
function SiteFooter() {
	...
	const [clickedPath, setClickedPath] = (0, import_react.useState)(null);
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							" Chaitanya EM High School, Chekkapalli. All rights reserved."
						] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function SiteHeader() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.header, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: `relative h-full w-full items-center px-2 md:flex md:justify-between md:px-6 ${isInner ? "grid grid-cols-[3.5rem_1fr_3.5rem]" : "flex justify-between"}`,
				children: [
					isInner && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex items-center justify-start md:hidden",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: () => router.history.back(),
							"aria-label": "Go back",
							className: `focus-luxe grid shrink-0 place-items-center rounded-full bg-white text-foreground ring-1 ring-black/5 shadow-[0_4px_14px_-6px_rgba(15,23,42,0.12)] transition-all duration-300 ease-out hover:scale-105 active:scale-95 ${scrolled ? "h-10 w-10" : "h-11 w-11"}`,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/",
						className: `flex min-w-0 items-center gap-1.5 sm:gap-2.5 md:gap-3 ${isInner ? "justify-center md:justify-start" : "justify-start pl-1 md:pl-0"}`,
						"aria-label": "Chaitanya EM High School — Home",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: "/logo-crest.jpeg",
							alt: "",
							className: `shrink-0 rounded-full object-cover ring-1 ring-black/5 transition-all duration-500 ease-out ${scrolled ? "h-8 w-8 sm:h-10 sm:w-10 md:h-11 md:w-11" : "h-9 w-9 sm:h-11 sm:w-11 md:h-13 md:w-13"}`
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: "/logo-wordmark.png",
							alt: "Chaitanya (E.M.) High School",
							className: `min-w-0 flex-shrink object-contain object-left max-w-[120px] sm:max-w-none transition-all duration-500 ease-out ${scrolled ? "h-8 sm:h-10 md:h-11" : "h-9 sm:h-11 md:h-13"}`
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
