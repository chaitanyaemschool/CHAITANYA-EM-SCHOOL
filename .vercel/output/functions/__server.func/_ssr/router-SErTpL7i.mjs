...
import { B as notFound, _ as createFileRoute, b as useNavigate, d as HeadContent, f as useRouterState, g as lazyRouteComponent, h as Outlet, m as createRouter, u as Scripts, v as createRootRouteWithContext, x as useRouter, y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/content-merge-DfUsPWOD.js
/**
...
var CONTENT_DEFAULTS = {
		...
		slides: [
			{
				...
				alt: "Chaitanya EM School — morning assembly with students"
			},
			{
			...
			},
			{
				...
				alt: "Chaitanya EM School campus aerial view"
			}
		]
	},
	home_about: {
	...
	about_hero: {
		...
		paragraph: "Since 2015, Chaitanya EM School has grown from a small neighbourhood school into a place where children learn, discover and grow with confidence — from Nursery to Grade 10.",
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-SErTpL7i.js
var router_SErTpL7i_exports = /* @__PURE__ */ __exportAll$1({
	a: () => useContent,
	c: () => waHref,
	getRouter: () => getRouter,
	i: () => useIsMobile,
...
var styles_default = "/assets/styles-B7gnoeR5.css";
/**
		...
		children: [!reduce && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.h1, {
					...
					children: "Chaitanya English Medium School"
				}),
...
var WA_ENQUIRY_MESSAGE = `Hello Chaitanya EM School,
...
function useContent(sectionKey) {
	const defaults = CONTENT_DEFAULTS[sectionKey] ?? {};
	const [data, setData] = (0, import_react.useState)(defaults);
	(0, import_react.useEffect)(() => {
		try {
			return onSnapshot(doc(db, "content", sectionKey), (snap) => {
				setData(mergeSection(sectionKey, snap.data()));
			});
		} catch {}
	}, [sectionKey]);
	return data;
...
var BTN = "group pointer-events-auto relative grid h-[44px] w-[44px] place-items-center overflow-hidden rounded-full text-white transition-[transform,box-shadow] duration-300 ease-out will-change-transform [transform:translateZ(0)] hover:-translate-y-0.5 hover:scale-[1.06] active:scale-[0.94] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background md:h-[48px] md:w-[48px]";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Gloss, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WhatsAppGlyph, { className: "relative h-[26px] w-[26px] text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)]" })]
			})
		]
	});
}
...
var Route$9 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "author",
				content: "Chaitanya EM School"
			},
			{
				property: "og:title",
				content: "Chaitanya EM School — Chekkapalli"
			},
			{
...
var $$splitComponentImporter$7 = () => import("./routes-BuL79a9x.mjs");
...
var $$splitComponentImporter$6 = () => import("./about-C0DiSZgN.mjs");
var Route$7 = createFileRoute("/about")({
	head: () => ({ meta: [
		{ title: "Our Story — Chaitanya EM School" },
		{
			name: "description",
			content: "Chapter two of Chaitanya EM School — how a small neighbourhood school in Chekkapalli grew into a home for curious minds from Nursery to Grade 10."
		},
		{
			property: "og:title",
			content: "Our Story — Chaitanya EM School"
		},
		{
			property: "og:description",
			content: "More than a school. A place to grow. The story, belief and journey behind Chaitanya EM School."
		},
		{
			property: "og:type",
			content: "article"
...
var $$splitComponentImporter$5 = () => import("./academics-8xJVL7JE.mjs");
var Route$6 = createFileRoute("/academics")({
	head: () => ({ meta: [
		{ title: "Academics — Chaitanya EM School" },
		{
			name: "description",
			content: "Foundation, Development and Excellence — a journey from Nursery to Grade 10 with the LEAD curriculum and IIT Foundation."
		},
		{
			property: "og:title",
			content: "Academics — Chaitanya EM School"
		},
		{
			property: "og:description",
			content: "From first words to first ranks."
		},
		{
			property: "og:type",
			content: "website"
									...
									children: items.map((item, i) => {
										...
										return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [imageField && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "aspect-[4/3] bg-secondary/60",
												...
												children: textFields.map((f, k) => {
													...
													if (!v) return null;
													return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className: k === 0 ? "text-[15px] font-semibold tracking-[-0.01em]" : "mt-1.5 text-[13px] leading-relaxed text-muted-foreground",
														children: v
													}, f.key);
												})
											})]
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "truncate text-[10px] font-semibold uppercase tracking-[0.24em] text-[#1c2a4d]/45",
						children: "Chaitanya"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: groups.map((g, gi) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						g.label && !mini && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "px-3 pb-1.5 pt-1 text-[9.5px] font-semibold uppercase tracking-[0.22em] text-[#1c2a4d]/35",
							children: g.label
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: g.items.map(({ id, label, icon: Icon, badge }) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									className: `group relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-left text-[13px] font-semibold transition-colors ${mini ? "justify-center" : ""} ${isActive ? "bg-[oklch(0.32_0.11_258)] text-white shadow-[0_14px_28px_-20px_rgba(28,42,77,0.95)]" : "text-[#1c2a4d]/70 hover:bg-[#1c2a4d]/[0.05] hover:text-[#1c2a4d]"}`,
									children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/",
					className: `flex items-center gap-2 rounded-xl px-3 py-2.5 text-[12.5px] font-semibold text-[#1c2a4d]/65 transition-colors hover:bg-[#1c2a4d]/[0.05] hover:text-[#1c2a4d] ${mini ? "justify-center" : ""}`,
					title: "View website",
					...
					className: "truncate rounded-xl bg-[#1c2a4d]/[0.04] px-3 py-2 text-[11px] text-[#1c2a4d]/55",
					children: email
				})]
			})
		]
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
										...
										className: "mt-0.5 hidden truncate text-[12px] text-[#1c2a4d]/55 sm:block",
										children: subtitle
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var $$splitComponentImporter$4 = () => import("./contact-BETcOJva.mjs");
var Route$4 = createFileRoute("/contact")({
	head: () => ({ meta: [
		{ title: "Contact — Chaitanya EM School" },
		{
			name: "description",
			content: "Get in touch with Chaitanya EM School, Chekkapalli. Call, WhatsApp or send a note."
		},
		{
			property: "og:title",
			content: "Contact — Chaitanya EM School"
		},
		{
			property: "og:description",
			content: "Simple, helpful, one tap away."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./facilities-CZZHloOt.mjs");
var Route$3 = createFileRoute("/facilities")({
	head: () => ({ meta: [
		{ title: "Facilities — Chaitanya EM School" },
		{
			name: "description",
			content: "Smart classrooms, science lab, library, playground and safe transport at Chaitanya EM School, Chekkapalli."
		},
		{
			property: "og:title",
			content: "Facilities — Chaitanya EM School"
		},
		{
			property: "og:description",
			content: "Every space, built for a child."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
var $$splitComponentImporter$2 = () => import("./gallery-82Sc-0Cl.mjs");
var Route$2 = createFileRoute("/gallery")({
	head: () => ({ meta: [
		{ title: "Life at Chaitanya EM School — Memories, Events & Moments" },
		{
			name: "description",
			content: "Every smile, every memory, every achievement. A visual diary of life at Chaitanya EM School, Chekkapalli."
		},
		{
			property: "og:title",
			content: "Life at Chaitanya EM School"
		},
		{
			property: "og:description",
...
*/
var $$splitComponentImporter$1 = () => import("./academics_._stage-D79N1u4E.mjs");
...
var $$splitComponentImporter = () => import("./admin_.dashboard-NDLr6VXN.mjs");
