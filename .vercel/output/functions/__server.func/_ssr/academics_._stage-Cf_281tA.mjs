import { f as getStage, r as Route$1 } from "./router-DnsFphIK.mjs";
...
import { t as useAcademicStage } from "./use-academic-stages-CIdgs_fQ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/academics_._stage-Cf_281tA.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mx-auto max-w-6xl px-6 pb-10 pt-[calc(110px_+_env(safe-area-inset-top))] md:px-10 md:pt-[calc(140px_+_env(safe-area-inset-top))] lg:px-16",
				children: [
