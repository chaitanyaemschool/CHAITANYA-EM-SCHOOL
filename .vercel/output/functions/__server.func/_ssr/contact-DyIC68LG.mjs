...
import { i as SiteHeader, n as ContactActions, r as SiteFooter, t as AdmissionDialog } from "./site-header-DyIaj2XA.mjs";
import { t as LocationSection } from "./location-section-al1A8sed.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/contact-DyIC68LG.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mx-auto max-w-6xl px-6 pt-[calc(110px_+_env(safe-area-inset-top))] pb-8 md:px-10 md:pt-[calc(140px_+_env(safe-area-inset-top))] lg:px-16",
				children: [
