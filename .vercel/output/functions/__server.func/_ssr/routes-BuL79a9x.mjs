...
import { g as hero_assembly_best_png_asset_default, h as hero_4_campus_png_asset_default, l as ACADEMIC_STAGES, m as hero_3_students_png_asset_default, o as useContent, p as hero_2_classroom_png_asset_default } from "./router-SErTpL7i.mjs";
...
import { i as SiteHeader, n as ContactActions, r as SiteFooter } from "./site-header-DXBCrAU8.mjs";
import { t as LocationSection } from "./location-section-9ztqq-53.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BuL79a9x.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative mx-auto flex h-full max-w-6xl flex-col justify-end px-5 pb-[clamp(9rem,34vh,15rem)] sm:px-10 sm:pb-32 lg:pb-36",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
						initial: {
							opacity: 0,
