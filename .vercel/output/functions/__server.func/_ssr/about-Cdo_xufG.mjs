...
import { _ as hero_classroom_full_png_asset_default, b as leader_nagaraju_png_asset_default, g as hero_assembly_best_png_asset_default, o as useContent, s as useIsMobile, v as lead_school_motto_jpeg_asset_default, y as leader_nagababu_png_asset_default } from "./router-DnsFphIK.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/about-Cdo_xufG.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				className: "relative flex flex-col gap-6 mt-10 md:mt-0 md:block md:h-[560px]",
				children: [
...
function TimelineItem({ m, i }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "absolute left-6 top-1/2 z-[2] -translate-x-1/2 -translate-y-1/2 md:left-1/2",
			...
			...revealProps,
			className: `col-start-1 col-end-2 row-start-1 ml-14 rounded-[28px] bg-white p-6 ring-1 ring-slate-200 shadow-sm md:ml-0 md:mt-0 md:p-8 transition-shadow duration-300 hover:shadow-md ${right ? "md:col-start-2 md:col-end-3" : "md:col-start-1 md:col-end-2 md:text-right"}`,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-[14.5px] leading-[1.6] text-slate-700 md:leading-[1.7] md:text-[15.5px]",
					children: m.body
				})
			]
		})]
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					!reduce && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
						"aria-hidden": true,
						style: {
							top: headTop,
							opacity: headOpacity
