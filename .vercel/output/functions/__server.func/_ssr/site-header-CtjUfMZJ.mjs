...
import { c as waHref, d as db, i as SOCIAL, n as DREAM_TEAM_URL, o as useContent } from "./router-TINUFHpO.mjs";
...
import { D as MapPin, F as House, J as CircleCheck, L as GraduationCap, N as Image, O as Mail, _ as Phone, it as ArrowUpRight, j as LoaderCircle, nt as BookOpen, p as School, t as X, tt as Building2, v as PhoneCall, w as Menu } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-header-CtjUfMZJ.js
...
function SiteHeader() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.header, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex h-full items-center justify-between gap-2 px-3 md:gap-3 md:px-6",
				children: [
