...
// Removed static gallery image imports.
...
export const CONTENT_DEFAULTS: Record<string, Record<string, unknown>> = {
  home_hero: {
    ...
    headline: "Chaitanya English Medium School",
    headlineTwo: "in Chekkapalli",
    subline:
      "An English Medium School in Chekkapalli offering education from Nursery to Grade 10 with activity-based learning, the LEAD curriculum, and IIT Foundation.",
