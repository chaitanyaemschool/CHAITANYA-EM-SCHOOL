...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Chaitanya EM School | Chekkapalli, Andhra Pradesh" },
      {
        name: "description",
        content:
          "Dare to dream, care to achieve. Get in touch with Chaitanya EM School, Chekkapalli. Call, WhatsApp or send a note for admissions or enquiries.",
      },
      { property: "og:title", content: "Contact Chaitanya EM School | Chekkapalli, Andhra Pradesh" },
      {
            ...
            <section className="px-4 pt-6 pb-12">
              <div className="overflow-hidden rounded-[28px] bg-white p-6 ring-1 ring-black/5 shadow-[0_20px_50px_-24px_rgba(15,23,42,0.25)] md:p-8">
                ...
                <p className="mt-2 max-w-[46ch] text-[13.5px] leading-relaxed text-muted-foreground">
                  Share a few details and our admissions office will reach out. It takes less than a
                  minute.
                </p>
                <button
                  type="button"
