...
export const Route = createFileRoute("/facilities")({
  head: () => ({
    meta: [
      { title: "School Facilities | Chaitanya EM School Chekkapalli" },
      {
        name: "description",
        content:
          "Dare to dream, care to achieve. Smart classrooms, science lab, library, playground and safe transport at Chaitanya EM School, Chekkapalli.",
      },
      { property: "og:title", content: "School Facilities | Chaitanya EM School Chekkapalli" },
      {
