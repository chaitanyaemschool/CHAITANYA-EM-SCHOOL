...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Chaitanya EM School | Chaitanya English Medium School Chekkapalli" },
      {
        name: "description",
        content:
          "Dare to dream, care to achieve. The story, belief and journey behind Chaitanya EM School — how a small neighbourhood school in Chekkapalli grew into an English Medium School for curious minds from Nursery to Grade 10.",
      },
      { property: "og:title", content: "About Chaitanya EM School | Chaitanya English Medium School Chekkapalli" },
      {
