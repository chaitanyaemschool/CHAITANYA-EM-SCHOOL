  ...
  head: () => ({
    meta: [
      { title: "Chaitanya EM School | English Medium School in Chekkapalli" },
      {
        name: "description",
        content:
          "Chaitanya EM School is an English Medium School in Chekkapalli, Andhra Pradesh, offering education from Nursery to Grade 10 with activity-based learning, LEAD curriculum, IIT Foundation and modern school facilities.",
      },
    ...
    <section id="top" ref={ref} className="relative min-h-[100svh] w-full overflow-hidden flex flex-col">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col pt-[clamp(140px,22svh,240px)] pb-24 px-5 sm:px-10 md:pt-[clamp(180px,28svh,300px)] md:pb-32 lg:pb-36 z-10">
        ...
        <div className="mt-4 pb-2 md:mt-5">
          ...
          >
            <span className="block">{cms.headline}</span>
            <span className="block text-white/95 mt-2 md:mt-0">{cms.headlineTwo}</span>
          </motion.h1>
        </div>
