...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.chaitanyaemschool.com/og-logo-round.jpeg" },
      { property: "og:image:secure_url", content: "https://www.chaitanyaemschool.com/og-logo-round.jpeg" },
      ...
      { name: "twitter:image", content: "https://www.chaitanyaemschool.com/og-logo-round.jpeg" },
    ],
    links: [
      {
        rel: "stylesheet",
