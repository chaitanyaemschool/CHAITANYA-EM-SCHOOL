        ...
        <div className="mt-10 grid gap-8 md:grid-cols-3 md:gap-10">
          ...
          <div className="relative">
            ...
            <div className="mt-8">
              ...
              <ul className="mt-3 grid grid-cols-2 gap-x-6 gap-y-2 text-[14px] text-background/85">
                {[
                  { label: "Nursery", to: "/nursery-school-chekkapalli" },
                  { label: "Primary", to: "/primary-school-chekkapalli" },
                  { label: "High School", to: "/high-school-chekkapalli" },
                  { label: "Transport", to: "/school-transport-chekkapalli" },
                ].map((n) => (
                  <li key={n.label}>
                    <Link
                      to={n.to}
                      className="block py-2 -my-2 transition-all duration-200 hover:text-background active:scale-95"
                    >
                      {n.label}
                    </Link>
                  </li>
